...
### グローバルナビ: HUG 風 上部水平タブ
現場が慣れ親しんでいる **HUG（株式会社こぱんはうす運営「さくら」シリーズ）** のナビ構造を踏襲。

- **上部水平タブバー**（固定）— 8 つの業務タブ＋右寄せユーザー
  - 🏠 ホーム / 👤 利用者管理 / 📝 個別支援計画 / 📓 日々の記録 / 📄 帳票・出力 / 🏢 本部管理 / ⚙️ 設定 / 👤 ユーザー
- **Pure CSS ドロップダウン**サブメニュー（ホバーで展開）
- **タブ直下のコンテキスト帯** — 事業所名・対象児童・日付・ヘルプ・ログアウト
- カラーは **クライアントロゴ Blue (#1e88e5)** を採用。HUG のオレンジ単色には寄せず、構造のみ HUG を踏襲してブランド独自性を維持。
- ダッシュボード（01）は HUG TOP を参考に密集タイル（6サマリ＋8クイックアクセス）を上下に配置。
